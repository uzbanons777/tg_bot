...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    keyboard = [
        ...
        [InlineKeyboardButton("ℹ️ Foydalanish yo'riqnomasi", callback_data="guide")],
    ]
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "guide":
        await query.edit_message_text(
            "📖 <b>Yo'riqnoma</b>\n\n"
            "1️⃣ 'Ilovani ochish' tugmasini bosing\n"
            "2️⃣Ism va telefon raqam kiriting\n"
            "3️⃣ Mahsulotlarni ko'ring\n"
            "4️⃣ Savatga qo'shing va buyurtma bering",
            parse_mode="HTML",
